export const AUTH_COOKIE = 'public_safety_emergency_response_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@public-safety-emergency-response.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@public-safety-emergency-response.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@public-safety-emergency-response.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
