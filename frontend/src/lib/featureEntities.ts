...
const entitySeeds = [
  ...
  ["wildfire-risk-forecast","Wildfire Risk Forecast Records","Wildfire Risk Forecast operating queue","Open","Wildfire Risk Forecast follow-up list","Wildfire Prediction Response","$0"],
  ["response-resource-plan","Response Resource Plan Records","Response Resource Plan operating queue","Review","Response Resource Plan follow-up list","Wildfire Prediction Response","$0"],
  ["evacuation-zone-review","Evacuation Zone Review Records","Evacuation Zone Review operating queue","Review","Evacuation Zone Review follow-up list","Wildfire Prediction Response","$0"],
