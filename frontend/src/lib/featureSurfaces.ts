...
const featureSeeds = [
  ...
  ["wildfire-risk-forecast","Wildfire Risk Forecast","Wildfire Risk Forecast review queue","Wildfire Prediction Response","Review source context and assign owner"],
  ["response-resource-plan","Response Resource Plan","Response Resource Plan review queue","Wildfire Prediction Response","Confirm next action and update evidence"],
  ["evacuation-zone-review","Evacuation Zone Review","Evacuation Zone Review review queue","Wildfire Prediction Response","Confirm next action and update evidence"],
