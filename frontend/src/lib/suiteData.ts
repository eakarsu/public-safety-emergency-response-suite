...
export const sourceSystems = [
  { name: 'AIPublicSafetyEmergencyResponseAssistant', ownership: 'Cases source capabilities and workflows', coverage: ['Cases', 'Incidents', 'Units'] },
  { name: 'AIPublicSafetyEmergencyResponseOperations', ownership: 'Incidents source capabilities and workflows', coverage: ['Schedules', 'Evidence', 'Permits'] },
  { name: 'AIPublicSafetyEmergencyResponseAnalytics', ownership: 'Units source capabilities and workflows', coverage: ['Approvals', 'Resources', 'Compliance'] },
  { name: 'AIPublicSafetyEmergencyResponseWorkflow', ownership: 'Schedules source capabilities and workflows', coverage: ['Alerts', 'Analytics', 'Reports'] },
];
