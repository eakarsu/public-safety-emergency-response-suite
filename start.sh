...
PORT="${PORT:-4830}"
DB_NAME="${PGDATABASE:-public_safety_emergency_response_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Public Safety Emergency Response Suite"
echo "======================================="
echo
...
echo "Starting public safety emergency response suite frontend on http://localhost:$PORT"
echo "Login: admin@public-safety-emergency-response.local / admin123"
